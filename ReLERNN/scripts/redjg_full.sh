...
DIR="./red_out/" # Output need to be in the same directory
VCF="/scratch/bioconsult/Maddy_Bursell/data/vcfs/red_junglefowl_autosomes_biallelic_fixup.vcf" # Can specify input vcf absolute path (can be different), default unphased GT
