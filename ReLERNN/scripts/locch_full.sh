...
VCF="/scratch/bioconsult/Maddy_Bursell/data/vcfs/local_chicken_autosomes_biallelic_fixup.vcf" # Can specify input vcf absolute path (can be different), default unphased GT
