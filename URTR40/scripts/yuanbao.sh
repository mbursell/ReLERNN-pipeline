...
DIR="./yunbao_out/" # Output need to be in the same directory
VCF="/home6/ycheng29/BIO624/data/yunbao_chicken_autosomes_biallelic.vcf" # Can specify input vcf absolute path (can be different), default unphased GT
